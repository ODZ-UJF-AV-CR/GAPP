...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/YVSXYR3DqU)
...
```sh
npx nx serve gapp-dashboard
```

To create a production bundle:

```sh
npx nx build gapp-dashboard
```

To see all available targets to run for a project, run:

```sh
npx nx show project gapp-dashboard
```
